...
def calculate_demographic_data(print_data=True):
    ...
    race_count = df['race'].value_counts().rename('race')
    ...
    countries = df.groupby('native-country')['high_income'].mean() * 100
    ...
    indian_high_income = (df['native-country'] == 'India') & (df['salary'] == '>50K')               
    top_IN_occupation = df[indian_high_income]['occupation'].value_counts().idxmax()
